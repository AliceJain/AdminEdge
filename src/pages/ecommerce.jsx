  ...
  return (
    <div className="mt-12">
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 m-3 p-4 dark:bg-secondary-dark-bg rounded-2xl md:w-780">
        ...
        <div>
          <div
            className="rounded-2xl md:w-400 p-4 m-2"
          ...
          <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl md:w-400 p-5 m-3 flex justify-center items-center gap-10">
            <div>
